...
// Initialize services
const calendarService = new CalendarService(config.googleCredentials, config.calendars);
const eventManager = new EventManager(config.eventsFile, calendarService);
const presetManager = new PresetManager(config.presetsFile);
